  ...
  <v-dialog persistent v-model="dialog" max-width="600px">
    ...
    <template v-slot:default="dialog">
      <div class="filtros">
        ...
        <v-select v-model="filtrarPor.autor" :items="autores" label="Autor" deletable-chips multiple chips small-chips
          outlined hide-details ref="autorSelect" @change="fecharMenu('autorSelect')"></v-select>

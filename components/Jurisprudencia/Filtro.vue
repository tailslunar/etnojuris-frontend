  ...
  <v-dialog persistent v-model="dialog" max-width="600px">
    ...
    <template v-slot:default="dialog">
      <div class="filtros">
        ...
        <v-select v-model="filtrarPor.competencia" :items="competencia" label="Competência" deletable-chips multiple
          chips small-chips outlined hide-details ref="competenciaSelect"
          @change="fecharMenu('competenciaSelect')"></v-select>

        <v-select v-model="filtrarPor.tribunal" :items="tribunal" label="Tribunal" deletable-chips multiple chips
          small-chips outlined hide-details ref="tribunalSelect" @change="fecharMenu('tribunalSelect')"></v-select>

        <v-select v-model="filtrarPor.relator" :items="relator" label="Relator(a)" deletable-chips multiple chips
          small-chips outlined hide-details ref="relatorSelect" @change="fecharMenu('relatorSelect')"></v-select>
...
<script>
export default {
  props: ['competencia', 'tribunal', 'relator', 'tags'],
  data() {
    return {
      dialog: false,
      filtrarPor: {},
